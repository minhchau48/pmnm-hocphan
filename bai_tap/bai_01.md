## Bài 1.2: Phân tích dự án rẽ nhánh do mâu thuẫn trong cộng đồng - Trường hợp Node.js và io.js
### 1. Bối cảnh và nguyên nhân mâu thuẫn
Node.js là một nền tảng chạy JavaScript phổ biến, được sử dụng nhiều để xây dựng các ứng dụng web và máy chủ. Node.js có một cộng đồng lập trình viên lớn và được nhiều công ty sử dụng.
Tuy nhiên, trong quá trình phát triển, một số nhà phát triển không đồng ý với cách quản lý và hướng phát triển của Node.js. Họ muốn dự án có cách quản lý mở hơn và được cập nhật các công nghệ mới nhanh hơn.
Vì những bất đồng này, một nhóm nhà phát triển quyết định tách khỏi Node.js để xây dựng một dự án mới.

### 2. Quá trình rẽ nhánh
Cuối năm 2014, dự án io.js được tạo ra từ mã nguồn của Node.js. Dự án được phát triển bởi một nhóm các nhà phát triển từng tham gia Node.js.
...
Tuy nhiên, việc rẽ nhánh cũng có thể làm cộng đồng và nguồn lực bị chia nhỏ. Vì vậy, sự hợp tác và thống nhất giữa các nhà phát triển là yếu tố quan trọng để dự án phát triển lâu dài.
